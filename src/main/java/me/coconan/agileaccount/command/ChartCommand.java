...
public class ChartCommand implements Command {
    ...
    public void execute() {
        ...
        System.out.printf(
                "%-10s %16s %16s %16s %16s %16s%% %16s %16s %16s %16s\n",
                "date",
                "delta cost",
                "total cost",
                "net in/out",
        ...
        for (LocalDate date = start;
            ...
            System.out.printf(
                    ...
                    chartRow.getInvestmentThisDate()
                            .subtract(chartRow.getDeltaFixedEarnings())
                            .setScale(2, RoundingMode.HALF_DOWN),
                    chartRow.getInvestmentStatsThisDate()
                            .getTotalAmount()
                            .setScale(2, RoundingMode.HALF_DOWN),
                    chartRow.getInvestmentStatsThisDate()
                            .getEarningRate()
