...
java -classpath {JAVA_8_HOME}/jre/lib/rt.jar:./out me.coconan.agileaccount.Application ~/enduring-patience/investment/assets.md ~/enduring-patience/investment/events.md ~/enduring-patience/investment/funds.md
